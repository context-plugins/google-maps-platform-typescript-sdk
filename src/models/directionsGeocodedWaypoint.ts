...
import { AreaType, areaTypeSchema } from './areaType.js';
import { GeocoderStatus, geocoderStatusSchema } from './geocoderStatus.js';
...
export const directionsGeocodedWaypointSchema: Schema<DirectionsGeocodedWaypoint> = typedExpandoObject(
  {
    geocoderStatus: ['geocoder_status', optional(geocoderStatusSchema)],
    partialMatch: ['partial_match', optional(unknown())],
    placeId: ['place_id', optional(string())],
    areaType: ['area_type', optional(array(areaTypeSchema))],
  },
