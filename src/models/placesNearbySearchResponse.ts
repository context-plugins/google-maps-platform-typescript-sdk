...
export const placesNearbySearchResponseSchema: Schema<PlacesNearbySearchResponse> = lazy(
  () =>
    typedExpandoObject(
      {
        htmlAttributions: ['html_attributions', array(string())],
        results: ['results', array(placeSchema)],
        ...
        nextPageToken: ['next_page_token', optional(string())],
      },
