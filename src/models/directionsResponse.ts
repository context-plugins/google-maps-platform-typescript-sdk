...
import {
  ...
  directionsGeocodedWaypointSchema,
} from './directionsGeocodedWaypoint.js';
import { DirectionsRoute, directionsRouteSchema } from './directionsRoute.js';
import {
  DirectionsStatus,
  directionsStatusSchema,
} from './directionsStatus.js';
...
export const directionsResponseSchema: Schema<DirectionsResponse> = lazy(() =>
  typedExpandoObject(
    {
      geocodedWaypoints: [
        'geocoded_waypoints',
        optional(array(directionsGeocodedWaypointSchema)),
      ],
      routes: ['routes', array(directionsRouteSchema)],
      status: ['status', directionsStatusSchema],
      availableTravelModes: [
        'available_travel_modes',
        optional(array(travelModeSchema)),
      ],
