...
export const cellTowerSchema: Schema<CellTower> = typedExpandoObject(
  {
    cellId: ['cellId', number()],
    locationAreaCode: ['locationAreaCode', number()],
    mobileCountryCode: ['mobileCountryCode', number()],
    mobileNetworkCode: ['mobileNetworkCode', number()],
    age: ['age', optional(number())],
    signalStrength: ['signalStrength', optional(number())],
    timingAdvance: ['timingAdvance', optional(number())],
  },
